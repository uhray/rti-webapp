...
<div class="Account">
  ...
  <img class="Account-photo" src={Logo} alt="Your profile" />
  ...
  <div>
    ...
    <Button primary outline>Remove</Button>
  </div>
  ...
  <form class="uk-form-stacked">
    <div class="row">
      <div class="uk-width-1-3 uk-margin-small-right">
        <Input
          ...
          placeholder={$userStore.user
            ? $userStore.user.contactInfo.firstName
            : ' '}
          fill
        />
      </div>
      <div class="uk-width-1-3 uk-margin-small-right">
        <Input
          label="Last Name"
          placeholder={$userStore.user
            ? $userStore.user.contactInfo.lastName
            : ''}
          fill
        />
      </div>
    ...
    <div class="row">
      <div class="uk-width-1-3 uk-margin-small-right">
        <Input
          label="Email"
          placeholder={$userStore.user ? $userStore.user.email : ''}
          fill
        />
      </div>
      <div class="uk-width-1-3 uk-margin-small-right">
